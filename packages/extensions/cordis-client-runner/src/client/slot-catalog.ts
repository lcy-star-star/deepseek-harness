...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.details.auxiliary\', () => ctx.slots.register(\n      { name: \'conversation.details.auxiliary\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  {
    key: 'sidebar.after.workspaces',
    kind: 'list',
    scope: 'root',
    summary: 'Additive content after the unchanged Workspace/Session browser.',
    doc: 'Additive content after the unchanged Workspace/Session browser. Entries\nreceive the same wide/rail state and expansion action as that browser.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.after.workspaces\', () => ctx.slots.register(\n      { name: \'sidebar.after.workspaces\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sidebar/src/client/contract/slots.ts:34',
  },
  {
    key: 'sidebar.before.workspaces',
    kind: 'list',
    scope: 'root',
    summary: 'Additive content before the unchanged Workspace/Session browser.',
    doc: 'Additive content before the unchanged Workspace/Session browser. Entries\nreceive the same wide/rail state and expansion action as that browser.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.before.workspaces\', () => ctx.slots.register(\n      { name: \'sidebar.before.workspaces\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
