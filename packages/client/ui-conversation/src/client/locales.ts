...
export const zh = {
  ...
  'details.back': '返回辅助面板',
  'details.open': '查看工具详情',
  'details.openShort': '详情',
  'details.empty': '点击工具行中的「详情」查看完整信息',
...
export const en = {
  ...
  'details.back': 'Back to auxiliary panel',
  'details.open': 'View Tool details',
  'details.openShort': 'Details',
  'details.empty': 'Use Details on a tool row to view the complete call',
