...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  conversationNavigation: 'client-side Conversation view controller — packages/client/ui-conversation/README.md owns the API',
  ...
  settingsNavigation: 'client-side Settings shell controller — packages/client/ui-settings-general/README.md owns the API',
